...
public class ADCOperationTests : BaseOperationTests<ADCOperation>
{
   ...
   {
      var opCodeDefinition = OpCodeDefinitions.OpCodeList.FirstOrDefault(x => x.Mnemonic == OpCode.ADC && x.AddressingMode == AddressingMode.IMM);
   ...
   {
      var opCodeDefinition = OpCodeDefinitions.OpCodeList.FirstOrDefault(x => x.Mnemonic == OpCode.ADC && x.AddressingMode == AddressingMode.ZP0);
